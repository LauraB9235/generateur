...
require_once __DIR__ . '/../nomAddOn4.class.php';
/**
 * Classe de gestion de la notification spécifique de l'add-onnomAddOn4
 *
 * 
 *
...
{
    //Template
    const PATH = 'specifs/addons/nomAddOn4/notification';
    //A créer
