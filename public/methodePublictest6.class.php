...
require_once \em_misc::getSpecifPath() . 'addons/test2/class/tools/Manager.class.php';

/**
 * Gestion du type de page "test5"
 *
 *
 *
...

{
     ...
     public function start()
     {
         ...
         $mx = \em_mx::initMx(\em_misc::getPublicTemplatePath('specifs/addons/test2/publication/crudList.html'));
      ...
      */
      public static function initListMx($mx)
      {
          ...
          $mxSearch = \em_mx::initMx(\em_misc::getPublicTemplatePath('specifs/addons/test2/publication/search.html'));
