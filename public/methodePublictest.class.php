...
require_once \em_misc::getSpecifPath() . 'addons/test/class/tools/Manager.class.php';
...
$mx = \em_mx::initMx(\em_misc::getPublicTemplatePath('specifs/addons/test/publication/crudList.html'));
...
$mxSearch = \em_mx::initMx(\em_misc::getPublicTemplatePath('specifs/addons/test/publication/search.html'));
